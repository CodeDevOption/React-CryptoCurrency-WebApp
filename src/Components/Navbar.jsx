...
import { selectClicked } from "../store/reducers/menuButton";

const Navbar = () => {
  const state = useSelector(selectClicked);
  const ActiveLink =
  ...
  return (
    <div
      className={`${
        !state && "hidden"
      }  md:block h-screen w-80 bg-gray-200 z-10 fixed md:sticky top-0 left-0 dark:bg-secondary-dark-bg p-5 pr-10`}
    >
      <div className="">
